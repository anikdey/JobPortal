...
class DepartmentController extends Controller
{
    ...
    public function __construct(DepartmentService $departmentService, JobPostService $jobPostService,
    ...
    public function deleteDepartmentById($id) {
        if(Auth::check() && Auth::user()->role == "ADMIN") {
            $department = $this->departmentService->findDepartmentById($id);
            $jobPosts = $this->jobPostService->getAllJobPostByDepartmentId($department->autoGeneratedDepartmentId);
            foreach($jobPosts as $jobPost) {
                $applications = $this->applicantService->findApplicationsByJobId($jobPost->autoGeneratedJobId);
                foreach($applications as $application) {
                    $this->applicantService->deleteApplicationById($application->id);
                }
                $this->jobPostService->deleteJobPostById($jobPost->id);
            }
